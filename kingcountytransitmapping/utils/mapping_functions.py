...
def create_kc_map(location=[47.608013, -122.335167], 
    ...
    m = folium.Map(location=location, zoom_start=zoom_start, max_zoom=max_zoom, min_lat=min_lat, 
                   max_lat=max_lat, min_lon=min_lon, max_lon=max_lon, max_bounds=True, control_scale=True)
